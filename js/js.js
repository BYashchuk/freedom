...
$(".js-lang").each(function () {
    ...
    $langToggler.on("click", function () {
        let lang = $(this).attr("href").substring(1);
...
!function (e, t) {
    ...
    let e = function (t, o) {
        let n = Object.create(e.prototype), i = 0, r = 0, s = 0, d = 0, l = [], a = !1,
        ...
        let m = "string" == typeof t ? document.querySelectorAll(t) : [t];
        if (!(0 < m.length)) throw Error("The elements you're trying to select don't exist.");
        n.elems = m;
        let p = function (e) {
            let t = e.getAttribute("data-rellax-percentage"), o = e.getAttribute("data-rellax-speed"),
                ...
                a = s + e.getBoundingClientRect().top, c = e.clientHeight || e.offsetHeight || e.scrollHeight,
                u = l + e.getBoundingClientRect().left, m = e.clientWidth || e.offsetWidth || e.scrollWidth;
            s = t || (s - a + r) / (c + r);
            let p = t || (l - u + d) / (m + d);
            ...
            for (var e = 0; e < n.elems.length; e++) {
                var t = h((s - l[e].left + d) / (l[e].width + d), (i - l[e].top + r) / (l[e].height + r), l[e].speed),
                    o = t.y - l[e].baseY, a = t.x - l[e].baseX;
